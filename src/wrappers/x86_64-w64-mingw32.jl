# Autogenerated wrapper script for LibTracyClient_jll for x86_64-w64-mingw32
export libTracyClient, libTracyClient_static

JLLWrappers.@generate_wrapper_header("LibTracyClient")
JLLWrappers.@declare_library_product(libTracyClient, "libTracyClient.dll")
JLLWrappers.@declare_file_product(libTracyClient_static)
function __init__()
    JLLWrappers.@generate_init_header()
    JLLWrappers.@init_library_product(
        libTracyClient,
        "bin\\libTracyClient.dll",
        RTLD_DEEPBIND,
    )
